...
Para evaluar este taller, utilizaremos **Mentimeter** al finalizar la sesión a través de una **encuesta de evaluación**.

### 1. Evaluación de Contenidos y Utilidad Percibida

Esta sección se realizará mediante una **matriz de doble entrada (2x2)** en una escala de 1 a 10 puntos para los siguientes contenidos:

- [x] Fundamentos de la IA
- [x] Herramientas y Estrategias con IA en la Práctica Docente
- [x] Ética en el Uso de la IA por parte del alumnado
- [x] La Creación de Prompts
- [x] Valoración Global de los Contenidos

La matriz permitirá evaluar dos aspectos clave para cada contenido:

* **Conocimiento Previo:** (1 - No conocía nada, 10 - Lo conocía todo)
* **Utilidad Prevista:** (1 - No lo veo útil, 10 - Lo veo totalmente útil)

### 2. Valoración del Impartidor

La evaluación concluirá con una **escala de valoración** (Totalmente en Desacuerdo - Totalmente de acuerdo) sobre los siguientes aspectos del impartidor:
...
- [x] Gestión del Tiempo
- [x] Valoración Global del Impartidor
