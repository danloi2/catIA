...
Introducción: Una breve introducción a la Primera Ley de Newton.
Explicación de la Inercia: Una definición clara y sencilla del concepto de inercia.
Ejemplos Cotidianos: Una lista con al menos tres ejemplos diferentes de la vida real que demuestren la inercia (por ejemplo, el movimiento de un pasajero en un coche al frenar, el polvo que sale de una alfombra al sacudirla, etc.). Para cada ejemplo, explica cómo se relaciona con la Primera Ley de Newton.
