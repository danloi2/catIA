...
## Decálogo para Generar un Prompt Educativo
...
* Describe el proceso de evaluación que se seguirá a lo largo de la SA (evaluación formativa y sumativa), especificando cómo se utilizarán diferentes instrumentos y estrategias de evaluación para atender a la diversidad de los estudiantes (**múltiples medios de acción y expresión** en la evaluación). Indica cómo se ponderarán los diferentes instrumentos para la calificación final.
