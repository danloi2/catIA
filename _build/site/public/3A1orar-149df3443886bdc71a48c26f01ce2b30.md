...
4. **PON EN PRÁCTICA** tu **Prompt Educativo Personalizado** utilizando la herramienta de IA q. **Evalúa el resultado inicial y, mediante la conversación con la IA (añadiendo más indicaciones o preguntas), intenta refinarlo para que se ajuste mejor a tus necesidades**. `(5')`
