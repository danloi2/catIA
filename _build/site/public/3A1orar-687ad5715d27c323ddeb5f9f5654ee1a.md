...
3. **GENERA o MEJORA** un **Prompt Educativo Personalizado** para una práctica docente. Puedes utilizar como base el prompt que creaste en la @2B1ritualesIA, revísalo y mejóralo utilizando los principios del Decálogo. Si es una actividad nueva, crea un prompt desde cero. Considera los siguientes aspectos al diseñar o mejorar tu prompt: `(15')`
