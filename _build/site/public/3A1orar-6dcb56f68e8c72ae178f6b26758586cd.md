...
3. **GENERA o MEJORA** un **Prompt Educativo Personalizado** para una práctica docente. Puedes utilizar como base el prompt que creaste en la @2B1ritualesIA, o partir de cero con una nueva práctica docente. 
