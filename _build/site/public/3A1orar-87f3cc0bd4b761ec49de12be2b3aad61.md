...
1.  **CONSIDERA**  o **ELIGE una nueva actividad** que actualmente realizas con tus estudiantes de secundaria. `(5')`

2. **Reflexiona** sobre  el **@decaprompt**. y cómo estos principios podrían aplicarse a una práctica docente que exploraste en la @2B1ritualesIA**
o la actividad que has elegido. `(5')`
