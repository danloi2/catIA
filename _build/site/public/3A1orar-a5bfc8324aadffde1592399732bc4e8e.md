...
3. **GENERA o MEJORA** un **Prompt Educativo Personalizado** para una práctica docente en base a los principios del **@decaprompt**. Puedes utilizar como base el prompt que creaste en la @2B1ritualesIA, o partir de cero con una nueva práctica docente: `(15')`

1.  **Rol**: Define el Rol de la IA
2.  **Tema**: Especifica el Tema o Asignatura
3.  **Objetivo**: Establece el Objetivo o Meta de Aprendizaje
4. ** Nivel:** Indica el Nivel de Conocimiento o Audiencia
5.  **Contexto:** Proporciona Contexto Detallado
6.  **Tarea:** Formula la Pregunta o Tarea Específica con Claridad y Precisión
7.  **Tono:** Define el Tono y el Estilo
8.  **Estructura:** Especifica la Estructura del Contenido Deseado
9.  **Formato:** Especifica el Formato de Salida Deseado
10. **Restricciones:** Establece Restricciones y lo que no Debe Incluirse
