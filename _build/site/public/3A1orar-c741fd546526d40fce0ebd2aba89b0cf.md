...
4. **PON EN PRÁCTICA** tu **Prompt Educativo Personalizado** utilizando alguna herramienta de IA @chatbot. **Evalúa el resultado inicial y, mediante la conversación con la IA (añadiendo más indicaciones o preguntas), intenta refinarlo para que se ajuste mejor a tus necesidades**. `(10')`
