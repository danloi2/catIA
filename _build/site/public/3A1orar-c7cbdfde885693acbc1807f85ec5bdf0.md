...
4. **PON EN PRÁCTICA** tu **Prompt Educativo Personalizado** utilizando la herramienta de IA . **Evalúa el resultado inicial y, mediante la conversación con la IA (añadiendo más indicaciones o preguntas), intenta refinarlo para que se ajuste mejor a tus necesidades**. `(5')`
5.  **COMPARTE** brevemente tu actividad actual, el prompt educativo personalizado (nuevo o mejorado) que has creado y **el resultado que obtuviste de la herramienta de IA**. `(5')`
