...
export function validateLicense(input, opts) {
    ...
    if (value.CC != null) {
        ...
        if (cc &&
            !((expected === null || expected === void 0 ? void 0 : expected.CC) || (output.url && new URL(output.url).host === 'creativecommons.org'))) {
...
export function simplifyLicenses(licenses) {
    ...
    if (content) {
        if (content.id) {
            simplified.content = removeExpectedKeys(content, (_a = ID_LICENSE_LOOKUP[content.id]) !== null && _a !== void 0 ? _a : {});
        }
        else {
    ...
    if (code) {
        if (code.id) {
            simplified.code = removeExpectedKeys(code, (_b = ID_LICENSE_LOOKUP[code.id]) !== null && _b !== void 0 ? _b : {});
        }
        else {
